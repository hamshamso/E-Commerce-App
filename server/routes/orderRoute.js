...
import {createOrder,getMyOrders,updateOrderStatus,getAllOrders,getProductsInfo,canselProductFromOrder} from '../controllers/orderController.js';
...
Router.delete('/orders/:orderId/:productId', ValidateUser, canselProductFromOrder)
